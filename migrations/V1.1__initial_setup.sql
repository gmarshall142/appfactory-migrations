...
37	35	Website Issues	\N	0	31	1	2	10	websiteissues
36	35	Email Administrators	\N	0	30	1	1	10	emailadmins
\.
...
SELECT pg_catalog.setval('app.appdata_id_seq', 1378, true);
...
SELECT pg_catalog.setval('app.appdataattachments_id_seq', 124, true);
...
SELECT pg_catalog.setval('app.attachments_id_seq', 164, true);
...
SELECT pg_catalog.setval('app.issues_id_seq', 394, true);
...
SELECT pg_catalog.setval('app.userattachments_id_seq', 158, true);
...
SELECT pg_catalog.setval('metadata.appcolumns_id_seq', 550, true);
...
SELECT pg_catalog.setval('metadata.formeventactions_id_seq', 268, true);
